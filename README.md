...
# 📖 The React Rails ONE-APP <a name="about-project"></a>


> The **React Rails ONE-APP** Connect previous knowledge of React and RAils with new knowledge of cobining bot in One App using Webpack with jsbundling-rails gem.
...
## Link to REACT App
[link](https://github.com/rebel216/Hello-Rails-React-front-end)
<!-- LIVE DEMO -->
...
```ruby
git clone https://github.com/rebel216/Hello-rails-BACK-END
```
...
Connect previous knowledge of React and RAils with new knowledge of cobining bot in One App using Webpack with jsbundling-rails gem.
